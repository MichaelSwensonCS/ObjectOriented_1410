...
public class EndSplash extends JPanel {
	...
	private void createTextPane(JTextPane txtPaneHighScoreHolder) {
		...
		try(BufferedReader reader = new BufferedReader(new FileReader("src/bombGame/ioReadWrite/TimeRemaining.txt"))){
	...
	private void createLblHighScoreHolder(JLabel lblHighScoreHolder) {
		lblHighScoreHolder.setOpaque(true);
		lblHighScoreHolder.setBackground(Color.WHITE);
		lblHighScoreHolder.setBounds(227, 281, 224, 208);
	}
	...
	private void createLblManualWriteInfo(JLabel lblManualWriteInfo) {
	}
