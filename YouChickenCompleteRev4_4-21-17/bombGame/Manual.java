...
public class Manual extends JPanel {
	...
	private void createInstructionPanel(JPanel pnlInstructions) {
		...
		try (BufferedReader reader = new BufferedReader(new FileReader("src/bombGame/text/MemoryInstructions.txt"));) {
		...
		try (BufferedReader reader = new BufferedReader(
				new FileReader("src/bombGame/text/SimonSaysInstructions.txt"));) {
		...
		try (BufferedReader reader = new BufferedReader(
				new FileReader("src/bombGame/text/SwitchesInstructions.txt"));) {
		...
		try (BufferedReader reader = new BufferedReader(
				new FileReader("src/bombGame/text/MorseCodeInstructions.txt"));) {
